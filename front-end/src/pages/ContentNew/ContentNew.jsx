        ...
        <form className="add__form">
          <div className="add__form-content-container">
            <div className="add__form-warehouse">
              ...
              <textarea className="add__form-warehouse-input add__form-warehouse-address-input" type="text" id="address" name="address" placeholder="Street Address" required />
              <label className="add__form-warehouse-title  add__form-warehouse-city-title" htmlFor="city">
                City
              </label>
              <textarea className="add__form-warehouse-input add__form-warehouse-city-input" type="text" id="city" name="city" placeholder="City" required />
              <label className="add__form-warehouse-title  add__form-warehouse-country-title" htmlFor="country">
                Country
              </label>
              <textarea className="add__form-warehouse-input add__form-warehouse-country-input" type="text" id="country" name="country" placeholder="Country" required />
            </div>
            <div className="add__form-contact">
              ...
              <textarea className="add__form-warehouse-input add__form-contact-name-input" type="text" id="contact" name="contact" placeholder="Contact Name" required />
              <label className="add__form-warehouse-title add__form-contact-position-title" htmlFor="position">
                Position
              </label>
              <textarea className="add__form-warehouse-input add__form-contact-position-input" type="text" id="position" name="position" placeholder="Position" required />
              <label className="add__form-warehouse-title  add__form-contact-number-title" htmlFor="number">
                Phone Number
              </label>
              <textarea className="add__form-warehouse-input add__form-contact-number-input" type="text" id="number" name="number" placeholder="Phone Number" required />
              <label className="add__form-warehouse-title add__form-contact-email-title" htmlFor="email">
                Email
              </label>
              <textarea className="add__form-warehouse-input add__form-contact-email-input" type="text" id="email" name="email" placeholder="Email" required />
            </div>
          </div>
